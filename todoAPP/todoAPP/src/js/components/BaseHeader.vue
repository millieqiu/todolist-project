<template>
  <div class="navbar bg-base-100 border-b">
    <div class="flex-1">
      <a class="btn btn-ghost text-xl" href="/Index"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
  ...
  <modal-setting ref="modalSetting"></modal-setting>
</template>
